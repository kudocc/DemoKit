...
@interface UILinearGradientView () {
    UILinerGradientViewAxis axis;
    CGGradientRef gradient;
}
@end

@implementation UILinearGradientView

- (id)initWithFrame:(CGRect)frame colors:(NSArray *)colors axis:(UILinerGradientViewAxis)ppaxis {
